    ...
    return (
      ...
      <ScrollView contentContainerStyle={webstyles.reportList}>
        {reports.map((report, index) => (
          <View key={report.id} style={[webstyles.reportContainer, index === reports.length - 1 ? { marginBottom: 60 } : {}]}>
      ...
      <TouchableOpacity 
        style={webstyles.fab} 
        onPress={()  => router.push('/newReports')}  // Change this to the desired action
      >
