            ...
            <View style={webstyles.container}>
                ...
                <View style={webstyles.mainContainer}>
                    ...
                    <ScrollView contentContainerStyle={webstyles.reportList}>
                        ...
                        <TouchableOpacity style={webstyles.dropdown} onPress={() => setIsDropdownVisible(!isDropdownVisible)}>
                            <Text style={webstyles.selectedText}>{selectedValue || "Select Crime Type"}</Text>
                        ...
                        {isDropdownVisible && (
                            <FlatList
                                ...
                                renderItem={({ item }) => (
                                    <TouchableOpacity style={webstyles.item} onPress={() => handleSelect(item)}>
                        ...
                        <View style={webstyles.buttonContainereditReport}>
                            ...
                            <TouchableOpacity style={webstyles.submitButtoneditReport} onPress={() => router.push('/viewReports')}>
