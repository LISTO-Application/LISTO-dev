    ...
    <ThemedView style={[styles.mainContainer]}>
      <ScrollView>
        ...
        <ImageBackground source={texture} style={styles.header}>
          ...
          <ThemedText lightColor='#FFF' darkColor='#FFF' type="title"> ADMIN </ThemedText>
        ...
        <ThemedView style={[styles.subContainer]}>
          ...
          <SpacerView height={40} borderBottomWidth={2} borderBottomColor='#C3D3DB' flexDirection="column" >
