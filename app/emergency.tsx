            ...
            >
                ...
                <SpacerView height = "5%" marginBottom = '5%'>
                  ...
                  >      
                              ...
                              <ThemedButton title='Holy Spirit' width = "1/3" height = '100%' paddingHorizontal = {25} marginHorizontal = '2.5%' type = "white-outline" onPress={() =>
                                  {router.replace({
                                    pathname: "/(tabs)",
                                  })}} />

                              <ThemedButton title='Matandang Balara' width = "1/3" height = '100%' paddingHorizontal = {25} marginHorizontal = '2.5%' type = "white-outline" onPress={() =>
                                  {router.replace({
                                    pathname: "/(tabs)",
                                  })}} />


                          <SpacerView width={80} height='auto'></SpacerView>
                ...
                <SpacerView height = "5%" marginBottom = '5%'>
                  ...
                  >
                          <ThemedButton title='Violent Crime' width = "1/3" marginHorizontal={5} paddingHorizontal = {25} height = '100%' type = "white-outline" onPress={() =>
                              {router.replace({
                                pathname: "/(tabs)",
                              })}} />

                          <ThemedButton title='Active Fire' width = "1/3" marginHorizontal={5} paddingHorizontal = {25} height = '100%' type = "white-outline" onPress={() =>
                              {router.replace({
                                pathname: "/(tabs)",
                              })}} />

                          <ThemedButton title='Serious Injury' width = "1/3" marginHorizontal={5} paddingHorizontal = {25} height = '100%' type = "white-outline" onPress={() =>
                              {router.replace({
                                pathname: "/(tabs)",
                              })}} />

                          <SpacerView width={10} height='auto'></SpacerView>
