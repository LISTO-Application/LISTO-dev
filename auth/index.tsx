      ...
      <AuthContext.Provider
        value={{
          ...
          register: async (email, password, fname, lname, pnumber, otp) => {
            ...
            console.log(typeof email, typeof password, typeof fname, typeof lname, typeof pnumber, typeof otp);
            const createUserResult = await firebase.app().functions("asia-east1").httpsCallable("createUser")({
              email: email,
              password: password,
              fname: fname,
              lname: lname,
